                ...
                {visibleItems.map((item, index) => {
                    ...
                    return (
                        <a
                            ...
                            className={`group flex gap-4 p-4 rounded-xl bg-[var(--bg-secondary)] border border-[var(--border)] hover:border-[var(--accent-cyan)]/50 hover:-translate-y-0.5 transition-all ${isNewlyRevealed ? 'animate-fade-in' : ''
                                }`}
